...
#SBATCH --output=/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024/fourparams/run_scripts/logs/R2_%A_%a.out
...
# Offset ID: Round 1 was 0-999. Round 2 should be 1000-1999.
# We add 1000 to the index to create unique folder names
FINAL_ID=$((SAMPLE_ID + 1000))
