...
#SBATCH --output=/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/run_scripts/logs/R4_%A_%a.out

# Configuration
NSIDE=512
TOTAL_SPLITS=1
WORK_DIR="/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new"
CSV_FILE="${WORK_DIR}/round4_samples.csv"
...
FINAL_ID=$((SAMPLE_ID + 900))

echo "Task ${SLURM_ARRAY_TASK_ID}: R4 Sample Index ${SAMPLE_ID} (ID ${FINAL_ID}), Split ${JDEVICE} of ${TOTAL_SPLITS}"
