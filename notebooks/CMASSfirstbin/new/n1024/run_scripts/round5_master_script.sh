...
#SBATCH --output=/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024/run_scripts/logs/R5_%A_%a.out

# Configuration
NSIDE=1024
TOTAL_SPLITS=1
WORK_DIR="/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024"
CSV_FILE="${WORK_DIR}/round5_samples.csv"
...
FINAL_ID=$((SAMPLE_ID + 1100))

echo "Task ${SLURM_ARRAY_TASK_ID}: R5 Sample Index ${SAMPLE_ID} (ID ${FINAL_ID}), Split ${JDEVICE} of ${TOTAL_SPLITS}"
