...
CSV_FILES = [
    ('/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024/fourparams/lhs_samples.csv',    0),
#    ('/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024/round2_samples.csv',1000),
#    ('/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024/round3_samples.csv',2000),
...
PRIOR_LOW    = [1.0, -0.3, -3.0, 0.01]
PRIOR_HIGH   = [6.0,  0.0,  3.0, 1.5]
PARAM_LABELS = [r'$\theta_{ej,0}$',
                r'$\nu_{\theta_{ej}}^{M}$',
                r'$\nu_{\theta_{ej}}^{z}$',
                r'$\mu_{\beta}$',]
PARAM_NAMES  = ['theta_ej_0', 'nu_theta_ej_M', 'nu_theta_ej_z', 'mu_beta']
PROPOSAL_STAT = 'JOINT'
VAL_FRACTION  = 0.10
...
if __name__ == '__main__':
    ...
    next_theta = sample_ensemble_direct(
        proposal_posterior, xo_proposal_norm, n_samples=1000)
    ...
    out_csv = (f'/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/new/n1024/fourparams/'
