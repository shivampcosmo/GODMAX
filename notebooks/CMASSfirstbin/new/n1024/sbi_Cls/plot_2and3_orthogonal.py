...
os.makedirs('plotcontours_Cls_orth', exist_ok=True)
...
for name in stat_map_keys:
    ...
    out_dir = Path(f'plotcontours_Cls_orth/{name}')
...
for group in tracer_groups:
    ...
    output_fn = f'plotcontours_Cls_orth/contour_comparison_{group["title"]}.png'
    g.export(output_fn)
