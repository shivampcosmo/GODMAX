...
THEORY_PARAM_NAMES = ['theta_ej_0', 'nu_theta_ej_M', 'mu_beta']
THEORY_PRIOR_MIN   = np.array([1.0, -0.3, 0.01])            # ← +0.01
THEORY_PRIOR_MAX   = np.array([6.0,  0.0, 1.5 ])            # ← +1.5
...
TRUTH_VALUES = np.array([2.0, -0.1, 0.5])                     # ← +0.5
PARAM_LIMITS = [(1.0, 6.0), (-0.3, 0.0), (0.01, 1.5)]# ← +mu_beta

# =============================================================================
# PATHS
# =============================================================================
OUTPUT_DIR      = 'plotcontours_hmcvssbi_3params_mubeta'                   # ← 4params
