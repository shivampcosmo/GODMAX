...
custom_colors = ['#3498db', '#e67e22', '#2ecc71']#, '#000000'] # Blue, Orange, Green, Black
...
g.triangle_plot(
    ...
    legend_labels=[r'$g^2 y$', r'$g^2 \kappa$', r'$g^2 \tau$'],# 'joint constraint'],
...
plt.savefig('godmax_comparison_plot_2params.png', bbox_inches='tight', dpi=300)
print("Plot successfully saved: godmax_comparison_plot_2params.png")
