...
print(f"Params: {args.theta_ej_0}, {args.mu_beta}")
...
for snap_num in snap_num_all[1:-1]:
    ...
    if zval < zmax_maps and zval > zmin_maps:
        sdir = f'/work/hdd/bdne/aacharya2/GODMAX/results/backlight_pkdgrav/CMASSfirstbin/twoparams/sample_{args.sample_id}'
