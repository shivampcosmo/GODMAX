...
#SBATCH --nodes=1
#SBATCH --time=01:00:00        # Each split gets its own 1.5h window
#SBATCH --gpus=1
#SBATCH --mem=400G
...
#SBATCH --output=/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/twoparams/run_scripts/logs/LHS_%A_%a.out

# Configuration
NSIDE=512
TOTAL_SPLITS=4
WORK_DIR="/work/hdd/bdne/aacharya2/GODMAX/notebooks/CMASSfirstbin/twoparams"
