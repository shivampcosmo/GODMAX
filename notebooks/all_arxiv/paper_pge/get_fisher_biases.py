...
samples_ws8_c1 = np.column_stack((samples, S8))
param_names_all_ws8_c1 = np.concatenate([param_names_all, ['S8']])
param_labels_all_ws8_c1 = np.concatenate([param_labels_all, [r'$S_8$']])
...
saved_dict_final_F['samples_ws8_c1'] = samples_ws8_c1
saved_dict_final_F['param_names_all_ws8_c1'] = param_names_all_ws8_c1
saved_dict_final_F['param_labels_all_ws8_c1'] = param_labels_all_ws8_c1
...
samples = np.random.multivariate_normal(mean, cov, 100000)
S8 = samples[:,4]*(samples[:,0]/0.3)**0.5
samples_ws8_c2 = np.column_stack((samples, S8))
param_names_all_ws8_c2 = np.concatenate([param_names_all, ['S8']])
param_labels_all_ws8_c2 = np.concatenate([param_labels_all, [r'$S_8$']])
chain2 = MCSamples(samples=samples_ws8_c2, names=param_names_all_ws8_c2,
                        labels=param_labels_all_ws8_c2, name_tag='chain2',settings=settings)

saved_dict_final_F['samples_ws8_c2'] = samples_ws8_c2
saved_dict_final_F['param_names_all_ws8_c2'] = param_names_all_ws8_c2
saved_dict_final_F['param_labels_all_ws8_c2'] = param_labels_all_ws8_c2

sig_S8_c1 = np.sqrt(chain1.cov(pars=['S8']))
sig_S8_c2 = np.sqrt(chain2.cov(pars=['S8']))
mean_S8_c1 = chain1.samples[:,-1].mean()
mean_S8_c2 = chain2.samples[:,-1].mean()
delta_S8 = np.abs(mean_S8_c2 - mean_S8_c1)
print(np.abs(delta_S8/sig_S8_c2))


saved_dict_final_F['sig_S8_c1'] = sig_S8_c1
saved_dict_final_F['sig_S8_c2'] = sig_S8_c2
saved_dict_final_F['mean_S8_c1'] = mean_S8_c1
saved_dict_final_F['mean_S8_c2'] = mean_S8_c2
saved_dict_final_F['bias'] = np.abs(delta_S8/sig_S8_c2)

save_fname = abs_path_results + f'/pge/fisher_biases_v2/Fisher_final_probes_{probes_forecast_all_str}_ellmax_{sc_val}.pk'
