...
# The following become optional if is_reference is set
...
if args.is_reference:
    ...
    # No updates needed here as generate_dicts(data) already pulled defaults
...
for snap_num in snap_num_all[1:-1]:
    ...
    if zval < zmax_maps:
        sdir = f'/work/hdd/bdne/aacharya2/GODMAX/results/backlight_pkdgrav/{save_folder}'
