...
# /mnt/home/spandey/ceph/GODMAX/results/pge/fisher_mats
save_fname = abs_path_results + f'/pge/fisher_mats_v2/Fisher_final_probes_{probes_forecast_all_str}_ellmax_{sc_val}.pk'
