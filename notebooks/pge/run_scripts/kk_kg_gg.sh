...
time srun python get_fisher_wpge.py "kk,gg,gk" 500
time srun python get_fisher_wpge.py "kk,gg,gk" 1000
time srun python get_fisher_wpge.py "kk,gg,gk" 2000
time srun python get_fisher_wpge.py "kk,gg,gk" 4000
time srun python get_fisher_wpge.py "kk,gg,gk" 8000
echo "done"
