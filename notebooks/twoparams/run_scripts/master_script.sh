...
#SBATCH --output=/work/hdd/bdne/aacharya2/GODMAX/notebooks/twoparams/run_scripts/logs/LHS_%A_%a.out

# Configuration
NSIDE=512
TOTAL_SPLITS=4
WORK_DIR="/work/hdd/bdne/aacharya2/GODMAX/notebooks/twoparams"
