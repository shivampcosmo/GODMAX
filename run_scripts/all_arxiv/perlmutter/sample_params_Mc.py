...
sims_params_vary_names = ['theta_ej_0', 'nu_theta_ej_M', 'log10_Mc0', 'nu_z', 'alpha_nt']
...
import dill as dill
save_chain_dir = abs_path_results + '/chains/'
dill.dump(trace, open(save_chain_dir + f'mcmc_probe_{probe}_deproj_{deproj}_{num_samples}_{num_warmup}_num_chains_{num_chains*n_parallel}_sample_Mc_NUTS_update.pkl', 'wb'))
