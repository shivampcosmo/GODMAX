...
#SBATCH --output=/projects/bdne/spandey3/new_godmax/GODMAX/run_scripts/delta/logs/%x.%j.out
#SBATCH --error=/projects/bdne/spandey3/new_godmax/GODMAX/run_scripts/delta/logs/%x.%j.err
...
cd /projects/bdne/spandey3/new_godmax/GODMAX/run_scripts/delta/
time srun --export=ALL python sample_params_simple.py cib_1p7_dBeta all poweradd
echo "done"
