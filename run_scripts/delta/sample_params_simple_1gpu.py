...
curr_path = '/projects/bdne/spandey3/GODMAX/run_scripts/delta/'
abs_path_data = os.path.abspath("/projects/bdne/spandey3/GODMAX/data/") 
abs_path_src = os.path.abspath( "/projects/bdne/spandey3/GODMAX/src/") 
abs_path_results = os.path.abspath("/projects/bdne/spandey3/GODMAX/results/") 
