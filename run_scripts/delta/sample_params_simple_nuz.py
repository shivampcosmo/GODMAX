...
try:
    smooth_mm_model = sys.argv[3]
except:
    smooth_mm_model = 'response'


try:
    smooth_ym_model = sys.argv[4]
except:
...
prior_max_all_dict['mu_beta'] = 1.2
...
prior_min_all_dict['nu_z'] = -0.5
prior_max_all_dict['nu_z'] = 1.0
...
prior_min_all_dict['A_IA'] = -2.5
prior_max_all_dict['A_IA'] = 2.5
prior_min_all_dict['eta_IA'] = -3.0
prior_max_all_dict['eta_IA'] = 3.0

prior_min_all_dict['alpha_1h2h_ym'] = 0.8
prior_max_all_dict['alpha_1h2h_ym'] = 1.2

prior_min_all_dict['alpha_1h2h_mm'] = 0.8
prior_max_all_dict['alpha_1h2h_mm'] = 1.2
...
# sims_params_vary_names = ['theta_ej_0', 'nu_theta_ej_M','nu_theta_ej_z', 'alpha_nt']
sims_params_vary_names = ['theta_ej_0', 'nu_theta_ej_z','nu_z', 'mu_beta', 'alpha_nt']

if smooth_mm_model == 'power_add':
    sims_params_vary_names.append('alpha_1h2h_mm')

if smooth_ym_model == 'power_add':
    sims_params_vary_names.append('alpha_1h2h_ym')
...
dill.dump(trace, open(save_chain_dir + f'mcmc_probe_{probe}_deproj_{deproj}_{num_samples}_{num_warmup}_num_chains_{num_chains*n_parallel}_narrowpriorfinal_thetaej_zev_mubeta_nuz_smoothing_mmym_{smooth_mm_model}_{smooth_ym_model}.pkl', 'wb'))
