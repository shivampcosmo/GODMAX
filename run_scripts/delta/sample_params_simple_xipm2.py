...
sim_params_dict['nu_theta_ej_z'] = 2.6
...
prior_min_all_dict['nu_theta_ej_M'] = -1.5
prior_max_all_dict['nu_theta_ej_M'] = 0.5
prior_min_all_dict['nu_theta_ej_z'] = -0.5
...
prior_min_all_dict['eta_IA'] = -2.5
prior_max_all_dict['eta_IA'] = 2.5
...
dill.dump(trace, open(save_chain_dir + f'mcmc_probe_{probe}_deproj_{deproj}_{num_samples}_{num_warmup}_num_chains_{num_chains*n_parallel}_narrowpriororig_thetaej_smoothing_mmym_{smooth_mm_model}_{smooth_ym_model}.pkl', 'wb'))
