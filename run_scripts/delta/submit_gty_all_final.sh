...
#SBATCH --job-name=test_fid_gty_final
...
which python
time srun --export=ALL python /projects/bdne/spandey3/GODMAX/run_scripts/delta/sample_params_simple.py cib_1p7_dBeta gty
echo "done"
