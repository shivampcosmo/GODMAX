...
# sims_params_vary_names = ['theta_ej_0','theta_co_0', 'nu_theta_ej_M', 'nu_theta_ej_z', 'delta_rhogas', 'mu_beta','alpha_nt']
sims_params_vary_names = ['theta_ej_0','theta_co_0', 'nu_theta_ej_M', 'nu_theta_ej_z','alpha_nt']
...
dill.dump(trace, open(save_chain_dir + f'mcmc_v4_probe_{probe}_modelmatter_{model_matter}_deproj_{deproj}_samples_{num_samples}_warmup_{num_warmup}_num_chains_{num_chains*n_parallel}_treedepth_{max_tree_depth}_gtysc_{use_gty_scale_cuts}_Y3xipmsc_{use_xipm_Y3_scale_cuts}.pkl', 'wb'))
