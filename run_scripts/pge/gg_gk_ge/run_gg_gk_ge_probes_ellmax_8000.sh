...
# time srun --export=ALL python sample_params_v5.py --probes="gg,gk,ge" --lmax=8000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4
time srun --export=ALL python sample_params_v5.py --probes="gg,gk,ge" --lmax=8000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4 --bao_prior=True
echo "done"
