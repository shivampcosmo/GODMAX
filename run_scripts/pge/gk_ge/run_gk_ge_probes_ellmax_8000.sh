...
unset __conda_setup
# <<< conda initialize <<<
conda activate /u/spandey3/.conda/envs/myjax3
# which python
module load cuda
module load cudnn
...
# time srun --export=ALL python sample_params_v1.py "gg,gk,ge" 1000
# time srun --export=ALL python sample_params_v5.py --probes="gk,ge" --lmax=8000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4
time srun --export=ALL python sample_params_v5.py --probes="gk,ge" --lmax=8000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4 --bao_prior=True
echo "done"
