...
#SBATCH --job-name=kkgggk_2000_bjax
#SBATCH -p gpu
#SBATCH -C a100-80gb
#SBATCH --mem=256G
#SBATCH --gpus=4
...
time srun --export=ALL python sample_params_v6_blackjax.py --probes="kk,gg,gk" --lmax=2000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4 --bao_prior=0 --model_matter="halofit"
echo "done"
