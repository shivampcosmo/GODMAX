...
time srun --export=ALL python sample_params_v5_halofit.py --probes="kk,gg,gk" --lmax=8000 --num_warmup=2000 --num_samples=2000 --num_chains=16 --max_tree_depth=4 --bao_prior=False --model_matter="halofit"
echo "done"
