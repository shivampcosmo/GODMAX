...
time srun --export=ALL python sample_params_v5.py --probes="kk,gg,gk" --lmax=8000 --num_warmup=3000 --num_samples=4000 --num_chains=24 --max_tree_depth=4 --bao_prior=True
echo "done"
