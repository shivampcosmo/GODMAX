...
#SBATCH --job-name=kk_gg_gk_ge_4000
...
time srun --export=ALL python get_Pmm_YM_fbM_constraints.py --probes="kk,gg,gk,ge" --lmax=4000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4 --nsel=1024
time srun --export=ALL python get_Pmm_YM_fbM_constraints.py --probes="kk,gg,gk,ge" --lmax=4000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4 --bao_prior=True --nsel=1024
echo "done"
