...
#SBATCH --job-name=ky_kk_gg_gy_gk_ge_8000
...
time srun --export=ALL python sample_params_v5.py --probes="ky,kk,gg,gy,gk,ge" --lmax=8000 --num_warmup=6000 --num_samples=6000 --num_chains=24 --max_tree_depth=4 --bao_prior=True
# time srun --export=ALL python sample_params_v5.py --probes="ky,kk,gg,gy,gk,ge" --lmax=8000 --num_warmup=9000 --num_samples=6000 --num_chains=24 --max_tree_depth=4
# time srun --export=ALL python sample_params_v5.py --probes="ky,kk,gg,gy,gk,ge" --lmax=8000 --num_warmup=3000 --num_samples=4000 --num_chains=24 --max_tree_depth=4 --init_strategy="value"
echo "done"
